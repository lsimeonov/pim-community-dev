...
use Akeneo\Pim\Enrichment\Component\Product\Validator\Constraints\UniqueValue as ConstraintsUniqueValue;
 ...
 */
final class UniqueValue implements DocumentationBuilderInterface
{
    public function support($object): bool
    {
        if (
            $object instanceof ConstraintViolationInterface
            && $object->getCode() === ConstraintsUniqueValue::UNIQUE_VALUE
        ) {
            return true;
        }
